    ...
    <div className="w-1/4 flex flex-col ">
        ...
        <p>{`${nft.contract.address.substr(0,4)}...${nft.contract.address.substr(nft.contract.address.length - 4)}`}</p>
            ...
            <div className='flex justify-center mb-1'>
              <a target={"_blank"} href={`https://etherscan.io/token/${nft.contract.address}`} className='py-2 px-4 bg-blue-500  text-center rounded-m text-white cursor-pointer'>View on Etherscan</a>
            </div>
        </div>
